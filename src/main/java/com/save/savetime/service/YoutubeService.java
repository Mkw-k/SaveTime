...
public class YoutubeService {
    ...
    public List<YoutubeList> getMyPlayListByYouTubeApi(String token) throws IOException {
        ...
        for (JsonNode children : itemsArrayNode){
            ...
            YoutubeList youtubeList = YoutubeList.builder()
                    .listId(children.get("snippet").get("channelId").toString())//채널 아이디
